Aim:To implement the Fractional Knapsack problem using the Greedy method by selecting items
based on the highest profit-to-weight ratio in order to maximize the total profit within the
