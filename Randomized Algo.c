Aim:To implement the Randomized Quicksort algorithm using a random pivot selection
technique in order to efficiently sort a list of elements and improve average-case performance.
Program :
#include <stdio.h>
#include <stdlib.h>
#include <time.h>
