Aim:To implement the Minimum Spanning Tree (MST) of a given graph using an appropriate 
algorithm (such as Prim’s or Kruskal’s) to find a subset of edges that connects all vertices
with minimum total edge weight and without forming any cycles
Program:
#include <stdio.h>
#include <stdlib.h>
...
void primMST(int graph[V][V])
{
    ...
    for (int count = 0; count < V - 1; count++)
    {
        ...
        for (int v = 0; v < V; v++)
        {
            // (u, v) is an edge and v is not visited and weight is smaller
