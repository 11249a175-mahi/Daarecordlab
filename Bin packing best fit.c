Aim: To write and implement a program for the Best Fit Bin Packing algorithm that places
     each item into the bin with the minimum available space that is sufficient for the item,
     in order to minimize the total number of bins used.
Program:
#include <stdio.h>
